 ...
 */
?>
<!-- TEMPLATE: woo-checkout-page — full-width wrapper around woocommerce/checkout block with page heading -->
...
<h2 class="wp-block-heading has-text-align-center has-main-color has-text-color" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--large);font-style:normal;font-weight:400"><?php esc_html_e( 'TODO: Checkout page heading', 'elayne' ); ?></h2>
<!-- /wp:heading -->
